...
See arch.md for plugin architecture details.
...
**Scope:** Email as single source. Implements features #1-3, #5-6, #9-11. Profile management, task creation, and behaviour tracking included. Context-aware presentation (#4), urgency tiers (#7), and plugin architecture (#8) deferred to V1.

**Success Criteria:**

- Single aggregated entry for redundant events
- >50% reduction in newsletter consumption time
- Zero missed OTP codes or delivery PINs
- Daily inbox zero workflow adoption
...
- Email sending and replies (consumption only for MVP)
